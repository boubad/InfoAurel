...
export class MaintainsDatabase extends PouchDatabase {
  ...
  create_profaffectations_design_docs() {
    let ddoc = {
  ...
  create_etudaffectations_design_docs() {
    let ddoc = {
